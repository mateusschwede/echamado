...
<div class="container-fluid">
            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item active"><a class="nav-link" href="admTecnico.php">Tecnicos</a></li>
    ...
    <div class="row">
        <div class="col-sm-12">
            <h1>Tecnicos</h1>
            <a class="btn btn-secondary btn-sm" href="addTecnico.php">Adicionar</a>
            <div class="list-group">
                <?php
                    $r = $db->query("SELECT * FROM tecnico WHERE ativo=1 ORDER BY nome");
                    ...
                    foreach($linhas as $l) {
                        echo "
                            <li class='list-group-item' id='item1'>
                                ...
                                <a class='btn btn-warning btn-sm' href='edTecnico.php?id=".base64_encode($l['id'])."'>Editar</a>
                                <a class='btn btn-danger btn-sm' href='inativarTecnico.php?id=".base64_encode($l['id'])."'>Inativar</a>
                            </li>
                        ";
                    }
                ?>
            ...
            <div class="list-group">
                <?php
                    $r = $db->query("SELECT * FROM tecnico WHERE ativo=0 ORDER BY nome");
                    $linhas = $r->fetchAll(PDO::FETCH_ASSOC);
                    foreach($linhas as $l) {
                        echo "
                            <li class='list-group-item' id='item2'>
                                ...
                                <p class='mb-1'>Senha: ".$l['senha']."</p>
                                <a class='btn btn-success btn-sm' href='ativarTecnico.php?id=".base64_encode($l['id'])."'>Ativar</a>
                            </li>
                        ";
                    }
                ?>
